  ...
  return (
    <>
      <motion.div
        ...
        className="w-36 md:w-52 inline-block  m-2 hover:scale-105 transition bg-gray-800 rounded-bl-[20px] rounded-tr-[20px] p-3"
      >
        <div className="relative mb-2">
          ...
          <div className=" shadow-lg bg-gradient-to-r from-blue-500 flex items-center justify-center bg-gray-600 rounded-md shadow-red-600 w-full p-5 h-60 opacity-0 transition-opacity duration-500 ease-in absolute top-0 right-0 hover:opacity-80">
            <Link to={`/details/${movie?.id}/movie`}>
              <button title="Watch on youtube" className=" font-semibold bg-red-600 shadow-red-500 text-white text-lg rounded-full py-1 px-3">
                Trailer
              </button>
            </Link>
          </div>
